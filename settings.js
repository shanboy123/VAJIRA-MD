...
const BOTNAME = 'ShanMd';
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94759549725' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=DVVFQIQL#FBuHn3RImY0aa5NueYv9kRfCbiZBogtTUQhnFJyjNyw' ,
